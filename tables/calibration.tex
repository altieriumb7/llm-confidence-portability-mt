...
anthropic/claude-opus-4-6 & 0.084 & 0.114 & 9.0\% & 2.1\% \\
anthropic/claude-sonnet-4-5-20250929 & 0.087 & 0.073 & 12.1\% & 1.0\% \\
gemini/gemini-2.5-flash & 0.152 & 0.055 & 4.3\% & 0.3\% \\
gemini/gemini-2.5-pro & 0.175 & 0.087 & 17.5\% & 0.0\% \\
openai/gpt-5-mini & 0.128 & 0.116 & 10.8\% & 0.0\% \\
openai/gpt-5-nano & 0.091 & 0.045 & 0.3\% & 0.3\% \\
openai/gpt-5.2 & 0.155 & 0.047 & 16.3\% & 0.0\% \\
\bottomrule
\end{tabular}
